...
export const Book = ({
    ...
    const _bottomColor = bottomColor ? bottomColor : (variant === "simple" && color !== undefined ? _color : undefined);
                    ...
                    >
                        ...
                        >
                            <div className="flex flex-col gap-2">
                                <span
                                    className={clsx(
                                        "leading-[1.1em] tracking-[-.02em] text-balance font-semibold",
                                ...
                                {author && (
                                    <span
                                        className="leading-[1.25em] tracking-[-.01em] text-balance text-[6cqw] opacity-80"
                                        style={{ color: textColor }}
                                    >
                                        {author}
                                    </span>
                            ...
                            {variant === "stripe" ? (
                                <img
                                    ...
                                    style={{ filter: 'brightness(0) invert(1)' }} // Make it white to match text color
                                />
                            ) : _illustration}
                        </div>
                    </div>
